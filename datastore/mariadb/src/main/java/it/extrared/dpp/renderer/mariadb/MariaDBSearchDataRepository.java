...
/**
 * An implementation of an {@link AbstractSearchDataRepository} supporting MariaDB storage.
 */
@Unremovable
@ApplicationScoped
public class MariaDBSearchDataRepository extends AbstractSearchDataRepository {

    @Inject ObjectMapper objectMapper;

    @Override
    protected Function<Row, JsonNode> jsonMapper() {
        return Unchecked.function(r -> objectMapper.readTree(r.getString("search_data")));
    }

    @Override
    protected SQLFilterVisitor getFilterVisitor() {
        return new MariaDBFilterVisitor();
    }
}
